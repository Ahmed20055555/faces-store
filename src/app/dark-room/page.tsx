...
export default function BalmyExperience() {
  ...
  return (
    <div className="min-h-screen flex flex-col font-tajawal dir-rtl">
      ...
      <style jsx global>{`
        .custom-dark-swiper.dark .swiper-button-next,
        .custom-dark-swiper.dark .swiper-button-prev {
          color: #ffffff !important;
        }
        .custom-dark-swiper.light .swiper-button-next,
        .custom-dark-swiper.light .swiper-button-prev {
          color: #000000 !important;
        }
        .custom-dark-swiper.dark .swiper-pagination-bullet {
          background: #ffffff !important;
        }
        .custom-dark-swiper.light .swiper-pagination-bullet {
          background: #000000 !important;
        }
        .custom-dark-swiper .swiper-button-next::after,
        .custom-dark-swiper .swiper-button-prev::after {
      ...
      >
          ...
          <div className="w-full max-w-2xl px-6 flex flex-col items-center animate-in fade-in zoom-in-95 duration-500">
            ...
            <div className="flex gap-3">
              {QUESTIONS.map((_, idx) => (
                <div
                  key={idx}
                  className={`w-2 h-2 rounded-full transition-colors duration-300 ${idx <= currentQIndex
        ...
        {stage === 'result' && (
          <div className="w-full max-w-5xl px-6 flex flex-col items-center animate-in fade-in duration-1000 h-full overflow-y-auto pt-20 pb-10">
            ...
            <div className="mb-8">
              <img
                src="/MB-Hero-P4Box-UAE-EN-2.avif"
                alt="Perfume Bottle"
            ...
            <div className="w-full max-w-6xl">
              <Swiper
                ...
                className={`w-full pb-12 custom-dark-swiper ${isBlackBg ? 'dark' : 'light'}`}
              >
                {(blackCount > whiteCount ? BLACK_COLLECTION : WHITE_COLLECTION).map((perfume) => (
                  <SwiperSlide key={perfume.id}>
                    <div
                      ...
                      className={`flex flex-col items-center p-8 border cursor-pointer hover:scale-[1.02] transition-all h-full ${isBlackBg ? 'border-white/20' : 'border-black/20'}`}
                    >

    ...
    <main className="min-h-screen bg-white" dir="rtl">
      ...
      <section className="relative h-[90vh] flex items-center overflow-hidden">
        ...
        <div className="max-w-[1400px] mx-auto px-4 md:px-12 relative z-10 w-full">
          <div className="max-w-2xl text-right text-white">
            ...
            <p className="text-base md:text-lg text-gray-300 leading-relaxed font-medium mb-12 max-w-xl">
      ...
      <section className="py-16 md:py-24 bg-white" id="branches">
        <div className="max-w-[1400px] mx-auto px-4 md:px-12">
          <div className="text-center mb-12 md:mb-20 space-y-4">
            ...
            <h2 className="text-2xl md:text-4xl font-black text-gray-900 leading-tight">تفضل بزيارة عالمنا</h2>
            <p className="text-gray-500 max-w-2xl mx-auto text-xs md:text-base font-medium leading-relaxed">
      ...
      <section className="py-8 bg-gray-900 text-white text-center mx-4 md:mx-12 mb-24 rounded-[4rem] relative overflow-hidden">
        <div className="relative z-10 max-w-2xl mx-auto px-4">
          <h2 className="text-2xl md:text-4xl font-black mb-8 leading-tight">هل أنت جاهز لتجد <br/> عطرك المميز؟</h2>
          <p className="text-gray-400 mb-12 text-sm md:text-base font-medium">سواء كنت تبحث عن الأناقة الكلاسيكية أو الجرأة العصرية، لدينا ما يناسب شخصيتك.</p>
